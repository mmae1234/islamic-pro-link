...
-- Extend business_accounts schema
...
-- professional_business_links join table
...
-- RLS policies for professional_business_links
...
-- business_accounts RLS updates per requirements
DO $$ BEGIN
...
-- Light backfill: default missing profiles.role to visitor (non-breaking)
